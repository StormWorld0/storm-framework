            ...
            if data[i:i+1] == TelnetCmd.IAC:
                ...
                if cmd in (TelnetCmd.DO, TelnetCmd.DONT, TelnetCmd.WILL, TelnetCmd.WONT):
                    ...
                    if cmd in (TelnetCmd.DO, TelnetCmd.DONT):
                        self.sock.send(TelnetCmd.IAC + TelnetCmd.WONT + opt, mode="send_only")
                    elif cmd in (TelnetCmd.WILL, TelnetCmd.WONT):
                        self.sock.send(TelnetCmd.IAC + TelnetCmd.DONT + opt, mode="send_only")
                ...
                # Command Eksekusi (2 Bytes)
                    ...
                    TelnetCmd.GA, TelnetCmd.EOF, TelnetCmd.SUSP, TelnetCmd.ABORT, TelnetCmd.EOR
                ):
                    i += 2
